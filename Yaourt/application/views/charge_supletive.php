            ...
            <div class="col-md-6">
                <form>
                    ...
                    <div class="mb-3">
                        ...
                        <button type="button" class="btn btn-dark btn-lg">Valider</button>
                        </div>
                    </div>
                </form>
            </div>
            <div class="col-md-6">
                <img src="assets/img/yaourtBon2.jpg" class="img-fluid rounded" alt="Image yaourt">
            </div>
        </div>
    </div>
</main>
